...
public class SocialNetwork
{
	...
	public void EditPrivacySettings (PrivacySettings ps)
	{
		bool ownerIsCaller = IsProfileOwnerMatch<bool>.Execute(new {ps.ProfileId});;
		if(ownerIsCaller)
            {
                throw new NotAuthorisedError();
            };
		XCall("Ethereum", "EditPrivacySettings", ProfileId, IsProfileVisible, ArePostsVisible);
	}
}